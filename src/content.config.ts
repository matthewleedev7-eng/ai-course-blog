...
const courses_pt = defineCollection({
  loader: glob({ pattern: '**/*.md', base: './src/content/courses_pt' }),
  schema: courseSchema,
});
...
const news_pt = defineCollection({
  loader: glob({ pattern: '**/*.md', base: './src/content/news_pt' }),
  schema: newsSchema,
});
